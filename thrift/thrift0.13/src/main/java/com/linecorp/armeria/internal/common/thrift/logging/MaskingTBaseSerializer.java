...
final class MaskingTBaseSerializer extends TBaseSerializer {

    private final TBaseSelectorCache cache;

    MaskingTBaseSerializer(TBaseSelectorCache cache) {
        this.cache = cache;
    }
    ...
    protected Object postProcess(TFieldIdEnum fieldId, FieldMetaData fieldMetaData, Object value) {
        return cache.getMapper(fieldId, fieldMetaData).mask(value);
    }
}
