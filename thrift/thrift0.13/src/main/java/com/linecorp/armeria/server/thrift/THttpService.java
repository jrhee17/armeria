...
public final class THttpService extends DecoratingService<RpcRequest, RpcResponse, HttpRequest, HttpResponse>
     ...
     */
    public static HttpService of(Object implementation) {
     ...
     */
    public static HttpService ofFormats(
     ...
     * {@link SerializationFormat#mediaType()}.
     */
    public static Function<? super RpcService, HttpService> newDecorator() {
    ...
    HttpResponse handleRequest(ServiceRequestContext ctx, HttpRequest req, THttpServiceHelper helper) {
        ...
        req.aggregate()
           .handle((aReq, cause) -> {
               ...
               decodeAndInvoke(ctx, aReq, serializationFormat, responseFuture, helper);
               return null;
    ...
    private void decodeAndInvoke(
        ...
        helper.invoke(ctx, serializationFormat, seqId, f, decodedReq, httpRes, req.toHttpRequest(), serviceName, methodName);
    }
