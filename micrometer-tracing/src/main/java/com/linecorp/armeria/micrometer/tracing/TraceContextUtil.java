...
public final class TraceContextUtil {
    ...
    public static class PingPongContext implements TraceContext {

        boolean pong;

        public void pong(boolean pong) {
            this.pong = pong;
        }
     ...
     */
    public static void ensureScopeUsesRequestContext(Tracer tracing) {
        ...
        final TraceContext dummyContext = new PingPongContext();
    ...
    public static final class PingPongExtra {
        ...
        public static boolean maybeSetPong(TraceContext context) {
            if (context instanceof PingPongContext) {
                ((PingPongContext) context).pong(true);
                return true;
            }
            return false;
        }
