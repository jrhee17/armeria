...
public final class CorsPolicy {
    ...
    public static CorsPolicyBuilder builder() {
        return new CorsPolicyBuilder(CorsOriginPredicate.any());
    }
    ...
    public static CorsPolicyBuilder builder(String... origins) {
        return builder(ImmutableSet.copyOf(origins));
    }
    ...
    public static CorsPolicyBuilder builder(Iterable<String> origins) {
        return new CorsPolicyBuilder(CorsOriginPredicate.origins(origins));
    }
    ...
    public static CorsPolicyBuilder builderForOriginRegex(Pattern regex) {
        return new CorsPolicyBuilder(CorsOriginPredicate.regex(regex));
    }
     ...
     * @deprecated use {@link CorsOriginPredicate#origins()} in {@link #originPredicate()} instead.
     */
    @Deprecated
