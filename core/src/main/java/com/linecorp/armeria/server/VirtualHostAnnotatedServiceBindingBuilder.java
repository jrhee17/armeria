 ...
 */
public final class VirtualHostAnnotatedServiceBindingBuilder extends AbstractAnnotatedServiceBindingBuilder {
    ...
    public VirtualHostAnnotatedServiceBindingBuilder responseConverters(
        ...
        return (VirtualHostAnnotatedServiceBindingBuilder) super.responseConverters(responseConverterFunctions);
    }
