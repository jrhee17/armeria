...
public interface QueryParamMaskingFunction {
    ...
    static QueryParamMaskingFunction of() {
        return DefaultQueryParamMaskingFunction.INSTANCE;
    }

    /**
     * Masks the specified {@code value} of the query parameter with the specified {@code name}.
     * If {@code null} is returned, the query parameter will be removed from the log.
     */
    @Nullable
