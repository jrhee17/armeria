...
final class AggregatedResponseAsUtil {
    ...
    public static <T> ResponseEntity<T> newJsonResponseEntity(AggregatedHttpResponse response,
    ...
    private AggregatedResponseAsUtil() {}
}
