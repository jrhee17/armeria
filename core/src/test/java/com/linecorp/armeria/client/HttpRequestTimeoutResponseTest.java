...
import com.linecorp.armeria.client.Http1ResponseDecoder.State;
...
public class HttpRequestTimeoutResponseTest {

    @Test
    void testHttp1RequestTimeout() throws Exception {
        ...
        try {
            ...
            assertThat(decoder.state).isEqualTo(State.DISCARD);
