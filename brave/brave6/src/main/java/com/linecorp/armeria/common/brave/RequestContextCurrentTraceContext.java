...
import com.linecorp.armeria.internal.common.brave.RequestContextCurrentTraceContextThreadLocal;
...
public final class RequestContextCurrentTraceContext extends CurrentTraceContext {
    ...
    public TraceContext get() {
        final TraceContext traceContext =
                RequestContextCurrentTraceContextThreadLocal.THREAD_LOCAL_CONTEXT.get();
    ...
    public Scope newScope(@Nullable TraceContext currentSpan) {
        ...
        final TraceContext threadPrev = RequestContextCurrentTraceContextThreadLocal.THREAD_LOCAL_CONTEXT.get();
        RequestContextCurrentTraceContextThreadLocal.THREAD_LOCAL_CONTEXT.set(currentSpan);

        class ThreadLocalContextScope implements Scope {
            @Override
            public void close() {
                RequestContextCurrentTraceContextThreadLocal.THREAD_LOCAL_CONTEXT.set(threadPrev);
            }
