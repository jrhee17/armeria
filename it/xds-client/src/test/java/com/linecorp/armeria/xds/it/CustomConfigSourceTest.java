...
import com.linecorp.armeria.xds.FactoryContext;
...
class CustomConfigSourceTest {
    ...
    void customConfigSourceFetchesClusterViaHttp() {
        ...
        try (XdsBootstrap xdsBootstrap = XdsBootstrap.builder(bootstrap)
                                                     ...
                                                     .extensionFactory(new HttpConfigSourceFactory())
    ...
    static final class HttpConfigSourceFactory implements SotwConfigSourceSubscriptionFactory {
        ...
        private SnapshotStream<DiscoveryResponse> fetchViaHttp(InterestedResources interest,
            ...
            return watcher -> {
                final WebClient client = WebClient.of(clusterSnapshot.httpPreprocessor());
