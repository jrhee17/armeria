    ...
    private static final Parser parser =
            JsonFormat.parser()
                      ...
                      .usingTypeRegistry(TypeRegistry.newBuilder()
                                                      ...
                                                      .add(io.envoyproxy.envoy.extensions.access_loggers.file.v3
                                                                   .FileAccessLog.getDescriptor())
                                                      .add(io.envoyproxy.envoy.extensions.upstreams.http.v3
                                                                   .HttpProtocolOptions.getDescriptor())
                                                      .add(io.envoyproxy.envoy.extensions.filters.http.compressor.v3
                                                                   .Compressor.getDescriptor())
                                                      .add(io.envoyproxy.envoy.extensions.compression.brotli
                                                                   .compressor.v3.Brotli.getDescriptor())
                                                      .add(io.envoyproxy.envoy.extensions.compression.zstd
                                                                   .compressor.v3.Zstd.getDescriptor())
                                                      .add(io.envoyproxy.envoy.extensions.compression.gzip
                                                                   .compressor.v3.Gzip.getDescriptor())
                                                      .add(io.envoyproxy.envoy.extensions.resource_monitors
                                                                   .downstream_connections.v3
                                                                   .DownstreamConnectionsConfig.getDescriptor())
