...
package com.linecorp.armeria.xds.it.filter;
...
public final class IstioNoOpFilterFactories {
    ...
    public abstract static class Base implements HttpFilterFactory<Empty> {
        @Override
        public Class<Empty> configClass() {
            return Empty.class;
        }

        @Override
        public Empty defaultConfig() {
