...
public final class IstioServerExtension extends HostOnlyExtension {
    ...
    @Override
    protected void setUp(ExtensionContext context) throws Exception {
    ...
    private void waitForReady(KubernetesClient client) {
        ...
        final boolean ready = K8sClusterHelper.poll(READY_TIMEOUT, K8sClusterHelper.DEFAULT_POLL_INTERVAL, () -> {
