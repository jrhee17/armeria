...
class XdsPreprocessorTest {
    ...
    void testWithListener() throws Exception {
        ...
        try (XdsBootstrap xdsBootstrap = XdsBootstrap.of(bootstrap);
             XdsHttpPreprocessor xdsPreprocessor = XdsHttpPreprocessor.ofListener(listenerName, xdsBootstrap)) {
    ...
    void testAllHttps() {
        ...
        try (XdsBootstrapImpl xdsBootstrap = new XdsBootstrapImpl(bootstrap, eventLoop.get(), customizer);
             XdsHttpPreprocessor xdsPreprocessor =
                     XdsHttpPreprocessor.ofListener(httpsListenerName, xdsBootstrap)) {
