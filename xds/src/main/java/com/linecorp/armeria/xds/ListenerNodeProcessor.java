...
interface ListenerNodeProcessor extends BaseNodeProcessor {
    ...
    default void process(ListenerResourceHolder holder) {
        ...
        if (connectionManager.hasRouteConfig()) {
            ...
            children().add(watchersStorage().addStaticNode(holder, XdsType.ROUTE, routeConfig.getName(), routeConfig));
            ...
            children().add(watchersStorage().subscribe(holder, configSource, XdsType.ROUTE, routeName));
        } else {
