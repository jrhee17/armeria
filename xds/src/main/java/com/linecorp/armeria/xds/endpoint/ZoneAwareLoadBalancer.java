...
final class ZoneAwareLoadBalancer implements LoadBalancer {
    ...
    private static class LbState {
        ...
        private final Map<Integer, PerPriorityState> perPriorityStateMap = new HashMap<>();
        ...
        Map<Integer, Integer> perPriorityHealth() {
            return perPriorityHealth;
        }

        Map<Integer, Integer> perPriorityDegraded() {
            return perPriorityDegraded;
        }
