...
public final class RouteEntry {
    ...
    RouteEntry(Route route, @Nullable ClusterSnapshot clusterSnapshot, int index,
        ...
        final Map<String, ParsedFilterConfig> routeConfigFilterConfigs =
                toParsedFilterConfigs(routeResource.resource().getTypedPerFilterConfigMap());
        final Map<String, ParsedFilterConfig> vhostFilterConfigs =
                toParsedFilterConfigs(vhostResource.resource().getTypedPerFilterConfigMap());
        final Map<String, ParsedFilterConfig> routeFilterConfigs =
                toParsedFilterConfigs(route.getTypedPerFilterConfigMap());
