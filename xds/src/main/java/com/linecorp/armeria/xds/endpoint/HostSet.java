...
class HostSet {
    ...
    HostSet(int priority, UpdateHostsParam params, Map<Locality, Integer> localityWeightsMap,
    ...
    public Map<Integer, Integer> healthyPriorityLoad() {
        return healthyPriorityLoad;
    }

    public Map<Integer, Integer> degradedPriorityLoad() {
        return degradedPriorityLoad;
    }
    ...
    static class LocalityEntry extends WeightedRandomDistributionSelector.Entry {
